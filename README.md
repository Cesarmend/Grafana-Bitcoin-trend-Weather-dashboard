...
- **Data sources** – can be configured via MySQL, PhpMyAdmin, an a Bitcoin public API.
  ![XAMP setup](https://github.com/Cesarmend/Grafana-Bitcoin-trend-Weather-dashboard/main/Pictutes/XAMPconfig.png)![phpMyAdmin](https://github.com/Cesarmend/Grafana-Bitcoin-trend-Weather-dashboard/blob/main/Pictutes/phpMyAdmin.png)
